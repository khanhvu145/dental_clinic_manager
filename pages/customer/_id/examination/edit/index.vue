        ...
        <form class="mt-3 mb-4" v-loading="dataLoading" v-on:submit.prevent="submitExaminationForm">
            <div class="row mt-3">
                <div class="col-md-12" style="text-align: right;">
                    ...
                    <button
                        v-if="
                            checkRight('cancelExamination') && $route.query.examinationId 
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <el-tabs v-model="activeName">
                        ...
                        <el-tab-pane v-if="$route.query.examinationId && $route.query.examinationId != 'create' && formData._id" label="File và hình ảnh chỉ định" name="fileAndImg">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="attachFile-content mt-3 mb-4" style="padding:0 12px;font-size:13px;line-height: 1.7;">
                                            ...
                                            >
                                                <form class="row" v-on:submit.prevent="submitDesignation">
                                                    <div class="col-md-12">
...
export default {
    ...
    methods: {
        ...
        async getData(){
            ...
            //Lấy danh sách khám và điều trị
            ...
            _this
                ...
                .then(async () => {
                    try{
                        ...
                        // console.log(_this.formData.diagnosisTreatment)
                        var oldData = cloneDeep(_this.formData);
                        var newData = new FormData();
                        buildFormData(newData, oldData);
        ...
        submitDesignation: debounce(async function (){
            ...
            try{
                ...
                _this.designationDialog.data.updatedBy = _this.userInfo.data.username;
                _this.designationDialog.data.createdBy = _this.userInfo.data.username;
