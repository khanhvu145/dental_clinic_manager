    ...
    <div class="wrapper">
        <div class="content" v-if="checkRight('view')">
            <div class="container-fluid">
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="title titleAfter mb-0">Quản lý loại hình dịch vụ</div>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <el-table :data="data.data" v-loading="dataLoading" style="width: 100%" stripe>
                            <el-table-column label="Mã dịch vụ" min-width="120">
                                <template slot-scope="scope">
                                    <div>{{ scope.row.code || '' }}</div>
								</template>
                            </el-table-column>
                            <el-table-column label="Tên dịch vụ" min-width="120">
                                <template slot-scope="scope">
                                    <div>{{ scope.row.name || '' }}</div>
								</template>
                            </el-table-column>
                            <el-table-column label="Giá dịch vụ" min-width="120">
                                <template slot-scope="scope">
                            ...
                            <el-table-column v-if="(checkRight('update'))" label="Thao tác" min-width="80">
                                <template slot-scope="scope">
                ...
                <el-dialog title="Tạo loại hình dịch vụ" :visible.sync="dialogCreateService" width="50%">
                    <form class="row" v-on:submit.prevent="submitCreateService">
                        <div class="col-md-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="col-form-label">Thời gian thực hiện tối thiểu *</div>
                                    <el-input 
                                        name="executionTime"
                                        placeholder="Thời gian thực hiện tối thiểu"
                                        v-model="createData.executionTime"
                                    >
                                        <el-select name="executionTimeType" v-model="createData.executionTimeType" slot="append" style="width: 80px;">
												<el-option
													v-for="(item, index) in executionTimeList"
													:key="index"
													:value="item.value"
													:label="item.label"
												></el-option>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <el-input 
                                        name="executionTime"
                                        placeholder="Thời gian thực hiện tối thiểu"
                                        v-model="updateData.executionTime"
                                    >
                                        <el-select name="executionTimeType" v-model="updateData.executionTimeType" slot="append" style="width: 80px;">
												<el-option
													v-for="(item, index) in executionTimeList"
													:key="index"
													:value="item.value"
